...
public class WholeSolution {
	...
	public ArrayList<Double> historyPoint=new ArrayList<Double>();
	public ArrayList<Double> historyDay=new ArrayList<Double>();
	public ArrayList<Double> historyHalfTerm=new ArrayList<Double>();
	public int progress=0;
	public timeProgress tp;
	/*
	...
	public void start() {
		...
		for(int i=0;i<ExcelReader.circumsNum;i++) {
			...
			double s=Double.valueOf(df.format(((double)(i+1)*100)/ExcelReader.circumsNum));
			//progress=Integer.valueOf();
			progress=(int)s;
			inform(tp);
		}
	}
	
	public void inform(timeProgress tp) {
		tp.changeValue(progress);
	}
	public void init() {
	...
	public void select() {
		...
		p1=best.getDayAverage();
		historyDay.add(p1);
		
		p1=best.getHalfTerm();
		historyHalfTerm.add(p1);
